                ...
                >
                    ...
                    <div className="ltr:left-0 rtl:right-0 absolute bottom-0 p-4 w-full">
                        <button className="btn btn-primary w-full" type="button" onClick={() => editNote()}>
                            <svg className="w-5 h-5 ltr:mr-2 rtl:ml-2 shrink-0" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                                            ...
                                                            <ul className="text-sm font-medium">
                                                                <li>
                                                                    <button type="button" onClick={() => editNote(note)}>
                                                                        <svg
                                                                            ...
                                                                            className="w-4 h-4 ltr:mr-3 rtl:ml-3 shrink-0"
                                                                        >
                                                                            <path
                                                                ...
                                                                <li>
                                                                    <button type="button" onClick={() => deleteNoteConfirm(note)}>
                                                                        <svg
                                                                            className="ltr:mr-3 rtl:ml-3 shrink-0"
                                                                            width="18"
                                                                            height="18"
                                                                            viewBox="0 0 24 24"
                                                                            fill="none"
