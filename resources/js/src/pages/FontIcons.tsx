        ...
        <div>
            <div className="space-y-8">
                <div className="panel flex items-center overflow-x-auto whitespace-nowrap p-3 text-primary lg:col-span-2">
                    ...
                    <a href="https://www.figma.com/file/agsPUbJSO4OcokUIxJRZvw/Solar-Icon-Set-(Community)?node-id=0%3A1&t=Xr5s4CqZbVgAQU9X-0" target="_blank" className="block hover:underline">
                        https://www.figma.com/file/agsPUbJSO4OcokUIxJRZvw/Solar-Icon-Set-(Community)?node-id=0%3A1&t=Xr5s4CqZbVgAQU9X-0
                    </a>
                </div>
                <div className="panel">
                    <h5 className="font-semibold text-lg dark:text-white-light mb-5">Solar Icon</h5>
                    <div className="mb-5">
                        <p className="mb-5">
