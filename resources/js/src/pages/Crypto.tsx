            ...
            <div className="flex flex-col xl:flex-row gap-5 relative mt-5">
                                    ...
                                    <div className="ltr:pr-4 rtl:pl-4">
                                        ...
                                        <div className={`flex items-center mt-2 ${item.isUp ? 'text-success' : 'text-danger'}`}>
                                            ...
                                            <div className="flex items-center font-normal">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={item.isUp ? 'rotate-180' : ''}>
                ...
                <div className="panel p-0 flex-1">
                    <div className="md:flex items-center flex-wrap p-4 border-b border-[#ebedf2] dark:border-[#191e3a]">
                        ...
                        <ul className="md:ltr:ml-auto md:rtl:mr-auto grid grid-cols-2 sm:grid-cols-4 font-semibold sm:divide-x rtl:divide-x-reverse divide-[#ebedf2] dark:divide-[#253b5c] text-white-dark mt-5 sm:mt-0">
